...
import 'package:myproject/models/category_item.dart';
import 'package:myproject/screens/category_items_screens.dart';
import 'package:myproject/widgets/category_item_card_widget.dart';
  ...
  void onCategoryItemClicked(BuildContext context, CategoryItem categoryItem) {
    Navigator.of(context).push(new MaterialPageRoute(
      builder: (BuildContext context) {
        return CategoryItemsScreen(category: categoryItem);
      },
    ));
  }
}
